...
const MoodTracker = () => {
        ...
        .on('value', snapshot => {
          ...
          if (response !== null) {
            ...
            Object.keys(response).forEach(key => {
              ...
              const { date, ...otherProps } = value
              result[date] = [otherProps]
            })
            setItems(result)
          }
        })
  ...
  const deleteEntry = async () => {
    ...
    try {
      await firebase.database().ref('/entry/' + id).remove();
      ...
      <View style ={{flex: 1, backgroundColor: 'white'}}>
        ...
        <View style = {styles.hdrIcons}>
          ...
          <TouchableOpacity
            onPress = {() => showModal()}
          >
            <AntDesign name="delete" size={30} color="red" style = {{marginRight: 20}}/>
          </TouchableOpacity>
        </View> 
        :
        <View style = {styles.hdrIcons}>
        ...
        <View style = {styles.textHdrView}>
          <Text style = {styles.textHdr}>{data.selectedDate.format('DD MMMM, YYYY')}</Text>
        </View>
        ...
        >
          <View style = {styles.modalView}>
            <View style = {styles.textView}>
              <Text style = {{fontSize: 20}}>Are you sure you want to delete this entry?</Text>
            </View>
            <View style = {styles.textView}>
              <Text style = {{fontSize: 20, color: 'red'}}>This action will be irreverisble</Text>
            </View>
            <View style = {styles.deleteView}>
              <TouchableOpacity 
                ...
                onPress = {() => hideModal()}
              >
                <Entypo name="cross" size={24} color="black" style = {{marginLeft: 10}}/> 
              ...
              <TouchableOpacity 
                ...
                onPress = {() => deleteEntry()}  
              >
                <Ionicons name="md-checkmark" size={24} color="black" style = {{marginLeft: 10}} />
        ...
        <Modal
          ...
          style = {{backgroundColor: 'transparent'}}
        >
          <View style = {[styles.modalView], [{flex: 1, justifyContent: 'center'}]}>
